...
export function InfiniteMovingCardsDemo() {
	return (
		<div className="h-[23rem] rounded-md flex flex-col antialiased bg-[#9EC8B9] dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
